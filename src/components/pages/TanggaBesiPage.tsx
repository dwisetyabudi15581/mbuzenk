...
import { CheckCircle2, Phone, MessageCircle, Award, Clock, Shield, ArrowRight, ArrowUpRight, RotateCcw, Ruler } from 'lucide-react'
...
const tanggaTypes = [
  {
    icon: ArrowUpRight,
    title: 'Tangga Lurus',
    description: 'Tangga besi lurus untuk akses antar lantai dengan desain minimalis dan kokoh.',
    features: ['Presisi tinggi', 'Anti slip', 'Desain minimalis'],
  },
  {
    icon: RotateCcw,
    title: 'Tangga Spiral',
    description: 'Tangga putar spiral untuk hemat ruang dengan tampilan artistik dan modern.',
    features: ['Hemat ruang', 'Artistik', 'Premium quality'],
  },
  {
    icon: Ruler,
    title: 'Tangga Custom',
    description: 'Tangga besi custom sesuai kebutuhan, bisa L-shape, U-shape, atau desain khusus.',
    features: ['Custom design', 'Sesuai ruangan', 'Konsultasi gratis'],
  },
]

const reasons = [
  { icon: Award, title: '19+ Tahun Pengalaman', desc: 'Spesialis tangga besi berpengalaman' },
  { icon: Clock, title: 'Pengerjaan Presisi', desc: 'Pengukuran dan fabrikasi akurat' },
  { icon: Shield, title: 'Garansi 2 Tahun', desc: 'Garansi konstruksi tangga' },
  { icon: CheckCircle2, title: 'Material SNI', desc: 'Besi hollow berkualitas tinggi' },
]

const advantages = [
  'Desain custom sesuai ruangan',
  'Perhitungan struktur akurat',
  'Material besi berkualitas',
  'Finishing rapi dan tahan lama',
  'Safety railings standar',
  'Anti slip pada anak tangga',
  'Harga kompetitif',
  'Garansi pemasangan',
]

export function TanggaBesiContent() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <ScrollAnimation>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 font-brand">
              Jasa Pembuatan Tangga Besi Magetan
            </h1>
            <p className="text-lg sm:text-xl text-white/90 max-w-3xl mb-8">
              Spesialis tangga besi, tangga spiral, dan tangga minimalis untuk rumah dan bangunan Anda. 
              Desain custom dengan standar keamanan tinggi. Pengalaman 19+ tahun.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                onClick={() => openWhatsApp('Halo, saya ingin pesan pembuatan tangga besi.')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation>
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-slate-800 mb-12 font-brand">
              Mengapa Pilih Kami untuk Tangga Besi?
            </h2>
          </ScrollAnimation>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation>
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-white mb-4 font-brand">
              Jenis Tangga Besi yang Kami Buat
            </h2>
            <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
              Berbagai model tangga besi sesuai kebutuhan dan ukuran ruangan Anda
            </p>
          </ScrollAnimation>
          <div className="grid md:grid-cols-3 gap-8">
            {tanggaTypes.map((type, index) => (
              <ScrollAnimation key={index} delay={index * 100}>
            ...
            <ScrollAnimation direction="right">
              <div className="bg-slate-100 rounded-2xl p-6 sm:p-8">
                ...
                <p className="text-slate-600 mb-6">
                  Hubungi kami untuk konsultasi gratis dan penawaran terbaik untuk tangga besi impian Anda.
                </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollAnimation>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                onClick={() => openWhatsApp('Halo, saya ingin pesan tangga besi.')}
