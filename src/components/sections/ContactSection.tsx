      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <ScrollAnimation direction="left" delay={0}>
                <Card 
                  ...
                  className="bg-slate-800/50 border-slate-700 hover:border-orange-500/50 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg"
                >
              ...
              <ScrollAnimation direction="right" delay={100}>
                <Card 
                  ...
                  className="bg-slate-800/50 border-slate-700 hover:border-green-500/50 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg"
                >
                  <CardContent className="p-4 sm:p-6">
              ...
              <ScrollAnimation direction="left" delay={200}>
                <Card 
                  ...
                  className="bg-slate-800/50 border-slate-700 hover:border-blue-500/50 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg"
                >
                  <CardContent className="p-4 sm:p-6">
              ...
              <ScrollAnimation direction="right" delay={300}>
                <Card 
                  ...
                  className="bg-slate-800/50 border-slate-700 hover:border-red-500/50 cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg"
                >
                  <CardContent className="p-4 sm:p-6">
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-slate-400 text-xs sm:text-sm">
                      ...
                      <span className="text-white font-medium">{CONFIG.openHours}</span>
                    </div>
                    <div className="flex justify-between text-slate-400 text-xs sm:text-sm">
                      <span>Minggu</span>
          ...
          <ScrollAnimation direction="right" delay={200}>
            <Card className="bg-slate-800/50 border-slate-700 hover:shadow-xl transition-shadow">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input 
                        ...
                        className="bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-500 focus:border-orange-500 min-h-[44px] focus:ring-orange-500/20"
                        value={formData.name}
                  ...
                  <div>
                    ...
                    <Textarea 
                      ...
                      className="bg-slate-700/50 border-slate-600 text-white placeholder:text-slate-500 focus:border-orange-500 resize-none focus:ring-orange-500/20"
                  ...
                  <Button 
                    type="submit" 
                    size="lg" 
                    className="w-full bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white shadow-lg shadow-orange-500/25 cursor-pointer min-h-[48px] group"
                  >
